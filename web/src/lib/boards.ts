...
export const ARDUINO_LEONARDO: BoardDef = {
  ...
  v33: [21],
  gnd: [4, 23, 24],
  reserved: [3, 19, 20, 25], // AREF, IOREF, RESET, and VIN
  ...
  pinMapping: {
    ...
    // Bottom row: IOREF RESET 3.3V 5V GND GND VIN A0 A1 A2 A3 A4 A5
    19: 'IOREF', 20: 'RESET', 21: '3.3V', 22: '5V', 23: 'GND', 24: 'GND', 25: 'VIN',
    26: 'A0', 27: 'A1', 28: 'A2', 29: 'A3', 30: 'A4', 31: 'A5'
  },
  oddLabels: {
    1: 'SCL', 3: 'AREF', 5: '13', 7: '11', 9: '9', 11: '7', 13: '5', 15: '3', 17: '1', 19: 'IOREF', 21: '3.3V', 23: 'GND', 25: 'VIN', 27: 'A1', 29: 'A3', 31: 'A5'
  },
  evenLabels: {
    2: 'SDA', 4: 'GND', 6: '12', 8: '10', 10: '8', 12: '6', 14: '4', 16: '2', 18: '0', 20: 'RESET', 22: '5V', 24: 'GND', 26: 'A0', 28: 'A2', 30: 'A4'
  },
...
export const PARTS: PartDef[] = [
  ...
  { id: 'dht22',  name: 'DHT22 Temperature', roles: ['Temperature'], minPins: 1, maxPins: 1 },
  { id: 'hcsr04', name: 'HC-SR04 Ultrasonic', roles: ['Distance'], pinLabels: ['Trigger', 'Echo'], minPins: 2, maxPins: 2 },
